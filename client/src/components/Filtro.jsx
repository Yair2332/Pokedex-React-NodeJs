...
function Filtro({ setPokeSelect, favoritos, setFavoritos, setListPoke }) {
                ...
                <div className="col-md-6">
                    ...
                    <div className="type-filter">
                        <button 
                            ...
                            onClick={() => {buscarPokemon(19, 'all'); setFavoritos(false)}}
                        >
                    ...
                    <div className="search-container">
                        ...
                        <input 
                            ...
                            onChange={(event) => { 
                                ...
                                setActiveButton(null); // Desactiva todos los botones al buscar por nombre
                            }} 
                        />
                    </div>
